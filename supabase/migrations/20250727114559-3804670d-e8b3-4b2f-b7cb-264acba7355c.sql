...
CREATE OR REPLACE FUNCTION public.can_manage_user_type(target_user_type tipo_usuario)
RETURNS boolean
LANGUAGE plpgsql
...
AS $function$
DECLARE
  current_user_type tipo_usuario;
BEGIN
  SELECT tipo_usuario INTO current_user_type 
...
BEGIN
  ...
  SELECT tipo_usuario INTO target_user_type 
  FROM public.usuarios 
